...
public class Questions : MonoBehaviour {
    ...
    void Start() {
        ...
        animals[21].InitializeAnimal(22, "Penguim", "Aptenodytes forsteri", true, false, false, Blood.Endotherms, Eggs.Oviparous, BodyCoverage.Feathers, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.Internal);
