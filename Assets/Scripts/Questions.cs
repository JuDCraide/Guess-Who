...
public class Questions : MonoBehaviour {
    ...
    void Start() {
        ...
        animals[11].InitializeAnimal(12, "Água viva", "Chrysaora fuscescens", false, false, true, Blood.None, Eggs.Oviparous, BodyCoverage.None, Coelomate.Acoelomate, EmbryonicLeaflet.Diploblastic, MouthOrigin.None, Symmetry.Radial, Skeleton.None, Reproduction.Both, Fecundation.External);
    ...
    public void AskQuestion() {
        ...
        Debug.Log("Pergunta: " + currentQuestion.question + " Resposta: " + answer);
        Debug.Log(answers);
