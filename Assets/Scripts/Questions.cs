...
public class Questions : MonoBehaviour {
    ...
    void Start() {
        ...
        animals[0].InitializeAnimal(1, "Morcego", "Pteropus giganteus", true, true, false, Blood.Endotherms, Eggs.Viviparous, BodyCoverage.Fur, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.Internal);
        animals[1].InitializeAnimal(2, "Ornitorrinco", "Ornithorhynchus anatinus", true, false, false, Blood.Endotherms, Eggs.Oviparous, BodyCoverage.Fur, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.Internal);
        animals[2].InitializeAnimal(3, "Tartaruga", "Trachemys dorbigni", true, false, false, Blood.Ectotherms, Eggs.Oviparous, BodyCoverage.Scales, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Both, Reproduction.Sexually, Fecundation.Internal);
        animals[3].InitializeAnimal(4, "Caracol", "Cornu aspersum", false, false, false, Blood.None, Eggs.Oviparous, BodyCoverage.Shell, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.None, Reproduction.Sexually, Fecundation.Internal);
        animals[4].InitializeAnimal(5, "Peixe palhaço", "Amphiprion ocellaris", true, false, false, Blood.Ectotherms, Eggs.Oviparous, BodyCoverage.Scales, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.External);
        ...
        animals[12].InitializeAnimal(13, "Polvo", "Octopus vulgaris", false, false, true, Blood.Ectotherms, Eggs.Oviparous, BodyCoverage.None, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.None, Reproduction.Sexually, Fecundation.Internal);
        animals[13].InitializeAnimal(14, "Estrela do mar", "Asterias rubens", false, false, false, Blood.None, Eggs.Oviparous, BodyCoverage.None, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.External);
        animals[14].InitializeAnimal(15, "Platelminto dividido", "Pseudoceros dimidiatus", false, false, false, Blood.Ectotherms, Eggs.Oviparous, BodyCoverage.None, Coelomate.Acoelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.None, Reproduction.Both, Fecundation.Internal);
        animals[15].InitializeAnimal(16, "Lombriga", "Ascaris lumbricoides", false, false, false, Blood.None, Eggs.Oviparous, BodyCoverage.None, Coelomate.Pseudocoelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.None, Symmetry.Bilateral, Skeleton.None, Reproduction.Sexually, Fecundation.Internal);
        animals[16].InitializeAnimal(17, "Minhoca", "Lumbricus terrestris", false, false, false, Blood.Endotherms, Eggs.Oviparous, BodyCoverage.None, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.None, Reproduction.Sexually, Fecundation.Internal);
        animals[17].InitializeAnimal(18, "Formiga", "Camponotus sp.", false, false, false, Blood.None, Eggs.Oviparous, BodyCoverage.None, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.Exoskeleton, Reproduction.Sexually, Fecundation.Internal);
        animals[18].InitializeAnimal(19, "Baleia", "Megaptera novaeangliae", true, false, false, Blood.Endotherms, Eggs.Oviparous, BodyCoverage.None, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.Internal);
        animals[19].InitializeAnimal(20, "Tubarão", "Carcharodon carcharias", true, false, false, Blood.Ectotherms, Eggs.Ovoviviparous, BodyCoverage.Scales, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.Internal);
        animals[20].InitializeAnimal(21, "Ostra", "Crassostrea gigas", false, false, false, Blood.Endotherms, Eggs.Oviparous, BodyCoverage.Shell, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.Exoskeleton, Reproduction.Sexually, Fecundation.External);
        animals[21].InitializeAnimal(22, "Pinguim", "Aptenodytes forsteri", true, false, false, Blood.Endotherms, Eggs.Oviparous, BodyCoverage.Feathers, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.Internal);
        animals[22].InitializeAnimal(23, "Cobra", "Crotalus durissus", true, false, true, Blood.Ectotherms, Eggs.Ovoviviparous, BodyCoverage.Scales, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Deuterostome, Symmetry.Bilateral, Skeleton.Endoskeleton, Reproduction.Sexually, Fecundation.Internal);
        animals[23].InitializeAnimal(24, "Caranguejo Eremita", "Neohelice granulata", false, false, false, Blood.None, Eggs.Oviparous, BodyCoverage.Shell, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.Exoskeleton, Reproduction.Sexually, Fecundation.Internal);
