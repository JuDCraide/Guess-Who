...
public class Questions : MonoBehaviour {
    ...
    void Start() {
        ...
        animals[12].InitializeAnimal(13, "Polvo", "Common octopus", false, false, true, Blood.Ectotherms, Eggs.Oviparous, BodyCoverage.None, Coelomate.Coelomate, EmbryonicLeaflet.Triblastic, MouthOrigin.Protostome, Symmetry.Bilateral, Skeleton.None, Reproduction.Sexually, Fecundation.Internal);
